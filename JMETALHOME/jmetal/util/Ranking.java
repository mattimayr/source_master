...
public class Ranking {
   ...
   * Constructor.
   * @param solutionSet The <code>SolutionSet</code> to be ranked.
   * @param surrogate The surrogate for classification
   */       
  public Ranking(SolutionSet solutionSet, Surrogate surrogate) {  
	if(surrogate != null) {
		solutionSet_ = surrogate.getRealSolutions();
	  ...
	  // If nobody dominates p, p belongs to the first front
		...
		System.out.println("A surrogate is needed to use this method of ranking!");
	}
  } // Ranking
