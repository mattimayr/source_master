...
public class MOEAD_main_args {
  ...
  public static void main(String [] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
	...
	if(args.length > 0 && args.length < 3) {
		...
		System.out.println("Usage: java MOEAD_main_args.java maxEvaluations populationsSize");
	}
  ...
  private static String getObjectiveFileName(int maxEvaluations, int populationSize) { 
	String fileName = "RANK0_MOEAD_Problem_" + maxEvaluations + "_" + populationSize;
	return fileName;
  }
  
  private static String getObjectiveFileNameTime(int time) { 
	String fileName = "RANK0_MOEAD_Problem_" + time + "Min";
	return fileName;
  }
} // MOEAD_main