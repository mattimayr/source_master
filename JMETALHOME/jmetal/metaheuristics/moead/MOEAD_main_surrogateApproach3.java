 ...
 */
public class MOEAD_main_surrogateApproach3 {
  ...
  private static String getObjectiveFileName(int maxEvaluations, int populationSize, int trainsetSize, long executionTime) { 
	String fileName = "";
	fileName = "RANK0_MOEAD_SM3_" + maxEvaluations + "_" + populationSize + "_" + trainsetSize + "_" + executionTime + "ms";
	return fileName;
  }
  
  private static String getObjectiveFileNameTime(int time, int populationSize, int trainsetSize) { 
	String fileName = "";
	fileName = "RANK0_MOEAD_SM3_" + time + "Min_" + populationSize + "_" + trainsetSize;
	return fileName;
  }
} // MOEAD_main