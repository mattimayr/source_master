...
public class MOEAD_PeriodicFronts extends Algorithm {
   ...
   */
  public MOEAD_PeriodicFronts(Problem problem) {
    super (problem) ;
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    SolutionSet ranked = new SolutionSet(population_.size());
    ...
    do {
      ...
      for (int i = 0; i < populationSize_; i++) {
        ...
        if(evaluations_%100 == 0) {
    		...
    		Ranking rank = new Ranking(population_);		
    		ranked = rank.getSubfront(0);
    		ranked.printObjectivesToFile("MOEAD_Problem_" + populationSize_ + "_" + maxEvaluations + "_" + evaluations_ + "_" + elapsedTime + "ms");
    	}
