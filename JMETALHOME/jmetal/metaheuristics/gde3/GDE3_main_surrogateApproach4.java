 ...
 */
public class GDE3_main_surrogateApproach4 {
  ...
  public static void main(String [] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
	...
	if(args.length > 0 && args.length < 4) {
		...
		System.out.println("Usage: java GDE3_main_surrogateApproach4 maxEvaluations populationsSize trainsetSize");
	}
  ...
  private static String getObjectiveFileName(int maxEvaluations, int populationSize, int trainsetSize, long executionTime) { 
	String fileName = "";
	fileName = "RANK0_GDE3_SM4_" + maxEvaluations + "_" + populationSize + "_" + trainsetSize + "_" + executionTime + "ms";
	return fileName;
  }
  
  private static String getObjectiveFileNameTime(int time, int populationSize, int trainsetSize) { 
	String fileName = "";
	fileName = "RANK0_GDE3_SM4_" + time + "Min_" + populationSize + "_" + trainsetSize;
	return fileName;
  }
} // GDE3_main