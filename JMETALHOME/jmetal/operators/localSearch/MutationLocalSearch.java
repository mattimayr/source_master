 ...
 * @throws JMException 
  ...
  public Object execute(Object object) throws JMException {
    ...
    int previousEvaluations = ((Integer) getParameter("evaluations")).intValue();
    ...
    do 
    {
      ...
      if (problem_.getNumberOfConstraints() > 0)
      {
        ...
        if (best == 0) //none of then is better that the other one
        {
          ...
          evaluations_++;
          if ((evaluations_ + previousEvaluations) % 100 == 0) {
              archive_.printFeasibleFUN("FUN_AbYSS_"+(previousEvaluations+evaluations_));
          }
