 ...
 */
public class EBEsSurrogateMethod3 extends Problem {
  /**
   * Constructor.
   ...
   */
	...
	public EBEsSurrogateMethod3(SolutionType solutionType) {
		solutionType_ = solutionType;
	}
	
	public EBEsSurrogateMethod3(SolutionType solutionType, int maxEvaluations) {
		solutionType_ = solutionType;
		maxEvaluations_ = maxEvaluations;
	}
	
  public EBEsSurrogateMethod3(String solutionType) throws ClassNotFoundException {
  ...
  public EBEsSurrogateMethod3(String solutionType, int maxEvaluations) throws ClassNotFoundException {
    if (solutionType.compareTo("BinaryReal") == 0)
      solutionType_ = new BinaryRealSolutionType(this) ;
    else if (solutionType.compareTo("Real") == 0)
      solutionType_ = new RealSolutionType(this) ;
  ...
  public void EBEsInitialize()  {
    ...
    try {
      ...
      Logger.getLogger(EBEsSurrogateMethod3.class.getName()).log(Level.SEVERE, null, ex);
    }
