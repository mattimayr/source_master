...
public class SurrogateWrapper extends Problem {
	...
	public SurrogateWrapper(Problem problem, int maxEvaluations, int populationSize, int numberOfInitialSolutions, int modelInitCounter, double epsilon, int machineLearningMethod) {
		this.problem = problem;
		this.method = 1;
	...
	public SurrogateWrapper(Problem problem, int maxEvaluations, int populationSize, int modelInitCounter, int realInitCounter) {
		this.problem = problem;
		this.method = 2;
	...
	public SurrogateWrapper(Problem problem, int method, int maxEvaluations, int populationSize, int trainSetSize, boolean dummy) {
		this.problem = problem;
		if(method == 3) {
			this.method = method;
