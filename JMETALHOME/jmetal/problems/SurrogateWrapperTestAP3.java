 ...
 *
 */
public class SurrogateWrapperTestAP3 extends Problem {
	...
	//constructors
	public SurrogateWrapperTestAP3(Problem problem, int populationSize) {
	...
	public SurrogateWrapperTestAP3(Problem problem, int maxEvaluations, int populationSize) {
		this.problem = problem;
		this.populationSize = populationSize;
	...
	public SurrogateWrapperTestAP3(Problem problem, int maxEvaluations, int method, int populationSize) {
		this.problem = problem;
		this.populationSize = populationSize;
		this.maxEvaluations = maxEvaluations;
		this.method = method;
	...
	public SurrogateWrapperTestAP3(Problem problem, int maxEvaluations, int populationSize, int numberOfInitialSolutions, int modelInitCounter, double epsilon, int machineLearningMethod) {
		this.problem = problem;
		this.method = 1;
	...
	public SurrogateWrapperTestAP3(Problem problem, int maxEvaluations, int populationSize, int modelInitCounter, int realInitCounter) {
		this.problem = problem;
		this.method = 2;
	...
	public SurrogateWrapperTestAP3(Problem problem, int method, int maxEvaluations, int populationSize, int trainSetSize, boolean dummy) {
		this.problem = problem;
		if(method == 3) {
			this.method = method;
	...
	public void useMethod3(Solution solution) throws JMException {
		int dominanceFlag;
		if(numberOfEval_ <= (maxEvaluations * 0.1)) {
			problem.evaluate(solution);
			realSolutions.add(solution);
			if(numberOfEval_ % (populationSize/trainSetSizeMethod3) == 0) {
				surrogateOF1.fillTrainSet(0, solution);
				surrogateOF2.fillTrainSet(1, solution);
			}
		} else {
