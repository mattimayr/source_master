 ...
 */
public class EBEsSurrogateMethod1 extends Problem {
  /**
   * Constructor.
   ...
   */
	...
	public EBEsSurrogateMethod1(SolutionType solutionType, int computeCounter) {
		solutionType_ = solutionType;
		this.computeCounter = computeCounter;
	}
	
  public EBEsSurrogateMethod1(String solutionType) throws ClassNotFoundException {
	...
	public EBEsSurrogateMethod1(String solutionType, int maxEvaluations) throws ClassNotFoundException {
	  if (solutionType.compareTo("BinaryReal") == 0)
	    solutionType_ = new BinaryRealSolutionType(this) ;
	  else if (solutionType.compareTo("Real") == 0)
	    solutionType_ = new RealSolutionType(this) ;
	...
	public void setComputeCounter(int computeCounter) {
		this.computeCounter = computeCounter;
	}
	
	private int numberOfInitialSolutions;
	
	private int initalComputeCounter;
...
//    String file = "Mobile_Bridge_25N_35B_8G_16OrdZXY.ebe";
    try {
      ...
      Logger.getLogger(EBEsSurrogateMethod1.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    // problem data print
      ...
      initalComputeCounter = 20;
      computeCounter = initalComputeCounter;
   ...
   */
    ...
    if(numberOfEval_ >= maxEvaluations_ - maxEvaluations_*0.1) {
    ...
    } else if(numberOfEval_ <= numberOfInitialSolutions) {
    	evaluateAndSet(solution);
    	realSolutions.add(solution);
    	...
    	if(computeCounter == 0) {
    		...
    		if(fx[0] < sol1) {
    			...
    			surrogate1.fillTrainSet(0, solution);
//    			System.out.println("sol1 = " + sol1 + "fx1 = " + fx[0]);
//    			System.out.println(surrogate1.getTrainSet().numInstances());
    			computeCounter = initalComputeCounter;
    		} 
    		if(fx[1] < sol2) {
    			System.out.println("Found better solution in objective 2 --> save to train set...");
    			surrogate2.fillTrainSet(1, solution);
//    			System.out.println("sol2 = " + sol2 + "fx2 = " + fx[1]);
//    			System.out.println(surrogate2.getTrainSet().numInstances());
    			computeCounter = initalComputeCounter;
    		} else {
    			System.out.println(initalComputeCounter + " model solutions are computed...");
    			computeCounter = initalComputeCounter;
